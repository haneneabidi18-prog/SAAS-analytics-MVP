...
def estimate_monthly_price(plan_tier: str, n_users: int) -> int:
...
def create_organization(name: str, plan_tier: str, max_users: int,
                        contact_email: str = "", notes: str = "") -> tuple[bool, str]:
...
def update_organization_plan(org_id: str, plan_tier: str, max_users: int) -> bool:
    try:
        sb = get_sb()
